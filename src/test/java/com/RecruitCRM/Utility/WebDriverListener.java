...
public class WebDriverListener extends TestBaseRecruitCRM implements WebDriverEventListener {
	
	private final static Logger LOGGER = Logger.getLogger("log4j.properties");//WebDriverListener.class);
